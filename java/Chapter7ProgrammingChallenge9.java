...
public class Chapter7ProgrammingChallenge9 {
    ...
    public double getAverageScore(int studentIndex) {
        ...
        return (total - lowestScore) / (testScores[studentIndex].length - 1);
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.printf("Average Score (excluding the lowest): %.2f\n", gradeBook.getAverageScore(i));
